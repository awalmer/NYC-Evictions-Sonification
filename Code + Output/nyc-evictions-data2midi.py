...
def map_value(value, min_value, max_value, min_result, max_result):
    ...
    return result
# Test it out
map_value(5, 1, 10, 100, 200) # ~ 144
map_value(10, 1, 10, 100, 200) # 200
...
instance = df['Index'].values
t_data = map_value(instance, 0, max(instance), 0, duration_beats)
...
'''
Note: may want to scale data (Matt does this by 0.5) --> y_data = y_data**0.5
...
print(str2midi('C3'))
# I'm doing C Aeolian (for somber-ish tone):
...
print(note_midis)
print('Resolution: ',len(note_midis),'notes')
